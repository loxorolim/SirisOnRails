...
void executeTest()
{
	...
	AutoPlanning* AP = setAutoPlanningFromFile(rubyPath+"/arqsTeste/metersInstanciaMédia3666.txt", rubyPath+"/arqsTeste/polesInstanciaMédia1030.txt", Urbano, t802_11_g, 6, 20, 3, 5, 1, 3, rubyPath);
