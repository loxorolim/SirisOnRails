...
string gridPlanningTest(AutoPlanning *AP,int gridSize, bool usePostOptimization)
{
	...
	string ret = AP->executeAutoPlanTestMode(usePostOptimization);
	return ret;
}
void executeTest()
{
	string rubyPath = "C:/Users/Guilherme/Documents/GitHub/SirisOnRails";
	AutoPlanning* AP = setAutoPlanningFromFile("C:\\Users\\Guilherme\\Documents\\GitHub\\SirisOnRails\\arqsTeste\\filemeters1000.txt", "C:\\Users\\Guilherme\\Documents\\GitHub\\SirisOnRails\\arqsTeste\\filepoles1000.txt", Urbano, t802_11_g, 6, 20, 3, 5, 1, 3, rubyPath);
	string result = "";
	result+=gridPlanningTest(AP, 50, true);
	result+=gridPlanningTest(AP, 50, false);
	cout << result;
